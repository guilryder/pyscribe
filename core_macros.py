...
class SpecialCharacters:
  ...
  TextNbsp = AppendTextMacro('text.nbsp', parsing.NBSP)
  TextNbspThin = AppendTextMacro('text.nbsp.thin', parsing.NBSP_THIN)
  TextSpFixed = AppendTextMacro('text.sp.fixed', parsing.SP_FIXED)
